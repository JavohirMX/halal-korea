        ...
        posts_data = [
            {
                ...
                <ul>
                    <li>Seoul Central Halal Market - Wide variety of halal meat and groceries</li>
                    <li>Itaewon Halal Shop - Convenient location with imported halal products</li>
                    <li>Online halal delivery services available throughout Seoul</li>
                </ul>

                <p>Remember to always verify halal certification when dining out or shopping for ingredients.</p>
                ''',
            ...
            },
            {
                ...
                <ul>
                    <li>Join local mosque communities in Seoul, Busan, and other major cities</li>
                    <li>Participate in cultural exchange events</li>
                    <li>Connect through social media groups and forums</li>
                </ul>

                <h2>Balancing Culture and Faith</h2>
                <p>Living in Korea while maintaining Islamic practices requires some adaptation, but the experience can be incredibly rewarding.</p>

                <h2>Support Networks</h2>
                <p>Don't hesitate to reach out to established community members who can provide guidance and support during your journey in Korea.</p>
                ''',
            ...
            },
            {
                ...
                <ul>
                    <li>Location-based filtering with GPS integration</li>
                    <li>Advanced category filtering (restaurants, markets, mosques, prayer rooms)</li>
                    <li>Real-time availability updates</li>
                    <li>User ratings and reviews integration</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Intuitive navigation designed for touch interfaces</li>
                    <li>Offline map functionality for saved places</li>
                    <li>Quick access to prayer times</li>
                </ul>

                <h2>What's Next?</h2>
                <p>We're continuously working on improvements based on user feedback. Stay tuned for more updates including multi-language support enhancements and community features.</p>
                ''',
